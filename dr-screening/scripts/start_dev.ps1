...
Write-Host ""
Write-Host "  Demo Mode : Active (no trained model yet)" -ForegroundColor Yellow
Write-Host "  To train  : Open notebooks/train_dr_model.ipynb on Kaggle" -ForegroundColor Yellow
Write-Host "========================================" -ForegroundColor Green
Write-Host ""
